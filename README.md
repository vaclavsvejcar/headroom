...
- [4. Installation](#4-installation)
    - [4.1. From Homebrew](#41-from-homebrew)
    - [4.2. From Pre-built Binaries](#42-from-pre-built-binaries)
    - [4.3. From Source Code](#43-from-source-code)
        - [4.3.1. Using Cabal](#431-using-cabal)
        - [4.3.2. Using Stack](#432-using-stack)
- [5. Basic Overview](#5-basic-overview)
    - [5.1. Main Concepts](#51-main-concepts)
    - [5.2. License Header Detection](#52-license-header-detection)
- [6. Quick Start Guide](#6-quick-start-guide)
    - [6.1. Initializing Headroom](#61-initializing-headroom)
        - [6.1.1. Automatic Initialization](#611-automatic-initialization)
        - [6.1.2. Manual Initialization](#612-manual-initialization)
    - [6.2. Running Headroom](#62-running-headroom)
- [7. Headroom Configuration](#7-headroom-configuration)
    - [7.1. YAML configuration file](#71-yaml-configuration-file)
    - [7.2. Command Line Arguments](#72-command-line-arguments)
- [8. Configuration Tips](#8-configuration-tips)
    - [8.1. Adding blank lines before/after license header](#81-adding-blank-lines-beforeafter-license-header)
    - [8.2. Putting license header before/after selected pattern](#82-putting-license-header-beforeafter-selected-pattern)
        - [8.2.1. put-before option](#821-put-before-option)
        - [8.2.2. put-after option](#822-put-after-option)
- [9. Command Line Interface Overview](#9-command-line-interface-overview)
    - [9.1. Init Command](#91-init-command)
    - [9.2. Run Command](#92-run-command)
        - [9.2.1. Add Headers Mode](#921-add-headers-mode)
        - [9.2.2. Replace Headers Mode](#922-replace-headers-mode)
        - [9.2.3. Check Headers Mode](#923-check-headers-mode)
        - [9.2.4. Drop Headers Mode](#924-drop-headers-mode)
    - [9.3. Generator Command](#93-generator-command)
        - [9.3.1. Supported License Types](#931-supported-license-types)
        - [9.3.2. Supported File Types](#932-supported-file-types)
...
### 6.1. Initializing Headroom

#### 6.1.1. Automatic Initialization
...
### 8.1. Adding blank lines before/after license header
...
### 8.2. Putting license header before/after selected pattern
